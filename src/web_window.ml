...
type t = <
  ...
  addEventListener : string -> Web_node.t Web_event.cb -> Web_event.options -> unit [@mel.meth];
  removeEventListener : string -> Web_node.t Web_event.cb -> Web_event.options -> unit [@mel.meth];
