...
external length_computable : Dom.progressEvent -> bool = "lengthComputable"
[@@mel.send]

external loaded : Dom.progressEvent -> int = "loaded" [@@mel.send]
external total : Dom.progressEvent -> int = "total" [@@mel.send]

external _target : 'e Dom.event_like -> 'a Dom.eventTarget_like Js.undefined
  = "target"
[@@mel.get]
...
module Target = struct
  ...
  external _checked : 'a Dom.eventTarget_like -> bool Js.undefined = "checked"
  [@@mel.get]
