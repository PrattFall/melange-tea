type style = <
   setProperty : Web_json.t Js.undefined [@mel.get]; (* TODO:  Revamp this and the next line... *)
   setProperty__ : string -> string Js.null -> string Js.null -> unit [@mel.meth];
   > Js.t

external getStyle : style -> string -> string Js.null = "" [@@mel.get_index]

external setStyle : style -> string -> string Js.null -> unit = "" [@@mel.set_index]
...
type t = <
  ...
  addEventListener : string -> t Web_event.cb -> Web_event.options -> unit [@mel.meth];
  removeEventListener : string -> t Web_event.cb -> Web_event.options -> unit [@mel.meth];
...
external getProp_asEventListener : t -> 'key -> t Web_event.cb Js.undefined = "" [@@mel.get_index]

external setProp_asEventListener : t -> 'key -> t Web_event.cb Js.undefined -> unit = "" [@@mel.set_index]
